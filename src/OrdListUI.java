...
Connection con;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(DISPLAYbtn, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
        ...
        setSize(new java.awt.Dimension(755, 354));
    ...
    private void DISPLAYbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DISPLAYbtnActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String OSid = rs.getString("SHOPKEEPER_ID");
              ...
              try
               {
                   ...
                   stmt1=con.createStatement();
                      ...
                      if(code==JOptionPane.YES_OPTION)
                       {
                         query2="UPDATE ITEM SET ORDERNO='"+N+"', ORDERDATE = '"+H+"',ITEM_ID="+M+",SHOPKEEPER_ID='"+L+"',QUANTITY="+P+",PRICE="+A+",DISCOUNT="+B+",AMOUNT="+C+" WHERE ORDERNO='"+N+"';";
